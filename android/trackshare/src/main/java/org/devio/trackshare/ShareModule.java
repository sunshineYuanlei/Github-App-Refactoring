...
public class ShareModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void share(final String text, final String img, final String weburl, final String title, final int sharemedia,
    ...
    @ReactMethod
    public void shareboard(final String text, final String img, final String weburl, final String title, final ReadableArray sharemedias,
                           final Callback successCallback) {
        runOnMainThread(new Runnable() {
            @Override
            public void run() {
